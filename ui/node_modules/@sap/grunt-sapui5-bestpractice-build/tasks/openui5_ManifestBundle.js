...
module.exports = function(grunt) {
    ...
    grunt.registerTask("createManifestBundle", "Task to bundle the manifest and i18n resources.", function() {
        var done = this.async();
        var distFolder = grunt.task.current.options().dest;
        var appFolder = grunt.task.current.options().src;

        createManifestBundle(appFolder, distFolder).then(function(message) {
            if (message) {
