...
destination | String | x | The name of the destination to which the incoming request should be forwarded.  The destination name can be a static string or a regex that defines the destination to be taken from the source property.
